...
<tr>
<td>
<asp:textbox id=text1 autopostback="true" 
    onTextChanged="text1_TextChanged" value="iniþial" runat="server" />
<p>
<asp:checkbox id=checkbox1 autopostback="true" 
    onCheckedChanged="checkbox1_CheckedChanged" runat="server" />
<p>
<asp:radiobutton id=radio1 autopostback="true" 
    Groupname=radioGroup onCheckedChanged="radio_CheckedChanged" runat="server" />
<asp:radiobutton id=radio2 autopostback="true" 
    GroupName=radioGroup onCheckedChanged="radio_CheckedChanged" runat="server" />
<p>
<asp:DropDownList id="dropdown1" autopostback="true" 
    onselectedIndexchanged="dropdown1_SelectedIndexChanged" runat="server">
...
<p>
<asp:ListBox id="listbox1" autopostback="true" Rows=4 
    onselectedIndexchanged="listbox1_SelectedIndexChanged" runat="server">
  <asp:ListItem value="A">Valoare 1</asp:ListItem>
  <asp:ListItem value="B">Valoare 2</asp:ListItem>
  <asp:ListItem value="C">Valoare 3</asp:ListItem>
...
<p>
<asp:ListBox id="listbox2" autopostback="true" Rows=4 
    SelectionMode="Multiple" onselectedIndexchanged="listbox2_SelectedIndexChanged" runat="server">
  <asp:ListItem value="A">Valoare 1</asp:ListItem>
  <asp:ListItem value="B">Valoare 2</asp:ListItem>
  <asp:ListItem value="C">Valoare 3</asp:ListItem>
  <asp:ListItem value="D">Valoare 4</asp:ListItem>
